...
Return ONLY valid JSON:
{
  ...
  fs.writeFileSync('proxy_raw2.txt', text);
  console.log("Written proxy_raw2.txt");
  ...
  fs.writeFileSync('proxy_json2.txt', jsonStr);
  console.log("Written proxy_json2.txt");
